package com.example.pitchbender;
...
//    double lowerLimitArr[] = {26.6824,28.2691,29.95,31.7309,33.6178,35.6167,37.7346,39.9784,42.3558,44.8742,47.5428,50.3695,53.3647,56.538,59.8999,63.4618,67.2355,71.2334,75.4691,79.9568,84.7113,89.7484,95.0854,100.739,106.729,113.076,119.8,126.924,134.471,142.466,150.938,159.914,169.423,179.496,190.171,201.478,213.459,226.152,239.6,253.848,268.942,284.934,301.877,319.828,338.845,358.993,380.34,402.957,426.918,452.305,479.199,507.694,537.882,569.868,603.754,639.655,677.689,717.988,760.682,805.914,853.836,904.609,958.401,1015.39,1075.76,1139.74,1207.51,1279.31,1355.38,1435.98,1521.36,1611.83,1707.67,1809.23,1916.8,2030.77,2151.53,2279.47,2415.02,2558.61,2710.77,2871.96,3042.72,3223.66,3415.34,3618.43,3833.6,4068.54};
//    double higherLimitArr[] = {28.3176,29.9529,31.7339,33.621,35.6202,37.7382,39.9823,42.3598,44.8786,47.5471,50.3746,53.3697,56.5435,59.9058,63.4678,67.2419,71.2403,75.4764,79.9644,84.7195,89.7572,95.0943,100.749,106.74,113.087,119.812,126.936,134.484,142.48,150.952,159.928,169.439,179.514,190.188,201.499,213.479,226.174,239.623,253.872,268.968,284.962,301.906,319.858,338.878,359.028,380.377,402.995,426.96,452.348,479.246,507.742,537.935,569.922,603.812,639.716,677.755,718.057,760.755,805.992,853.918,904.695,958.492,1015.49,1075.87,1139.84,1207.62,1279.44,1355.51,1436.11,1521.51,1611.98,1707.84,1809.39,1916.99,2030.97,2151.73,2279.69,2415.25,2558.87,2711.02,2872.24,3043.02,3223.96,3415.68,3618.78,3833.97,4061.95,4303.48};
    ...
    /*
    *   Tweaks:
    *   Overlap(i2) - Performs better for fast audio when overlap is used (i2). Initially it was 0.
    *   Sampling rate - No idea what effect this has. Remember to change two times.
    *   Buffer size - Does not work for small buffer size(512). Gives error buffer size should be greater than 4096.
    */
    ...
    public void processPitch(float pitchInHz, HashMap<Integer, String> map) {
        ...
        if(map.get(getNote(pitchInHz, 0, 87)) != null)
            noteText.setText(noteText.getText() + map.get(getNote(pitchInHz, 0, 87))+" ");  //assuming 88 notes
    ...
    /*
    *   Code logic: Tell the user if he played the right note. If yes(the note found in any buffer) green else red(if note not found after x number of buffers)
     */
}
